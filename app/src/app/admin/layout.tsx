...
export default function AdminLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-stone-100 flex font-sans relative">
            {/* Sidebar */}
            <aside className="w-64 bg-primary-900 text-white flex flex-col shadow-xl z-20">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <Link href="/admin" className="flex items-center gap-3 px-4 py-3 rounded-lg text-primary-100 hover:bg-primary-800 hover:text-white transition-colors">
                    ...
                    <Link href="/admin/inventario" className="flex items-center gap-3 px-4 py-3 rounded-lg text-primary-100 hover:bg-primary-800 hover:text-white transition-colors">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden relative z-10">
                ...
                <header className="bg-white border-b border-stone-200 px-6 py-4 flex justify-between items-center shadow-sm z-10">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-sm text-stone-500">Bienvenido, Admin</span>
                        <div className="h-9 w-9 bg-primary-100 text-primary-700 rounded-full flex items-center justify-center font-bold border border-primary-200 shadow-inner">
                            A
                        </div>
                    </div>
                </header>
